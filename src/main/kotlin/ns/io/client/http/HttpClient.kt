...
class HttpClient: IHttpClient {
    ...
    private fun createHttpClient(): OkHttpClient {
        return OkHttpClient.Builder()
            ...
            // Connection pooling: OkHttpClient has a connection pool that keeps track of available connections to
            // reuse them instead of creating a new connection for each request. By default, it holds 5 connections
            // per host.
